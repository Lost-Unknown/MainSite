  ...
  return (
    <div className="w-full">
      ...
      <div className="flex w-full flex-col">
          <iframe
            width="560"
            className="w-full carousel-height"
            height="315"
            src="https://www.youtube.com/embed/h_5kJOgwlf8?si=kYCVr3lwj7omNkYt"
            title="YouTube video player"
            frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
            allowfullscreen
          ></iframe>
          <p className="lilita-font text-white text-outline-b1 text-3xl">
          I Turned Takeshi's Castle into a Mobile Game
          </p>
        </div>
        <div className="flex w-full flex-col">
          <iframe
