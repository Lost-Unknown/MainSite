...
const Games = () => {
  return (
    ...
    <div className='w-full grid  lg:grid-cols-3 h-auto md:grid-cols-2 grid-cols-1 gap-3'>
      <Link href='/games' className='flex flex-col gap-4 no-underline bg-white/20 w-full  p-4 rounded-3xl hover:bg-white/40 transition-all'>
        <Image 
        ...
        <div className='flex flex-col justify-start items-start'>
          ...
          <p className='lilita-font text-white text-outline-b1 text-2xl'>Coming Soon</p>
