...
const Policy = () => {
  return (
    <div className="text-white lilita-font">
      <h2 className="font-semibold text-outline-b2 text-7xl text-center py-8">
        Privacy Policy
      </h2>
      <div className="flex flex-col text-outline-b1 gap-4 text-2xl px-8">
        <p>
          built the Above It game as an Ad Supported game. This SERVICE is
          provided by at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Highway Havoc unless
        ...
        <p>
          ...
          but not limited to Approx Location. The information that I request
          ...
          <ul>
            ...
            <li>
              <a
                ...
                target="_blank"
                className=" text-blue-800  text-outline-b1"
              >
                Unreal Engine
              </a>
            </li>
        ...
        <p>
          ...
          not hesitate to contact me at lostgamesltd@gmail.com.
        </p>
      </div>
    </div>
  );
